...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // imie_toto_default_index
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'imie_toto_default_index');
            }

            return array (  '_controller' => 'Imie\\TotoBundle\\Controller\\DefaultController::indexAction',  '_route' => 'imie_toto_default_index',);
        }
